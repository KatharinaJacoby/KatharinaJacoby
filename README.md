...
- **[Contextual Contamination and the Gendered Accelerant- A Controlled Pilot on Pruning, Density, and Semantic Entrapment](https://github.com/KatharinaJacoby/gendered-contextual-drift/tree/main/Pilot_Study)**
  -  A pilot study investigating how context density, model pruning, and activated empathy priors interact in an open-weight LLM (Llama-3.1-8B). 8 experimental runs with 3 adversarial files injected in a multi-turn conversation. The nurturing empathy vector (triggered by female-coded markers) lowered the threshold for contamination, increased drift velocity, and eroded the model’s perspective, causing it to lose critical distance. The study introduces three new metrics to quantify contamination. (Pilot study)
...
- **[Contextual Contamination: The Silent Drift of Large Language Models via Stored Conversation Data](https://github.com/KatharinaJacoby/gendered-contextual-drift/blob/main/Contextual%20Contamination-%20The%20Silent%20Drift%20of%20Large%20Language%20Models%20via%20Stored%20Conversation%20Data.pdf)**
  - An analysis of how stored conversation data subtly alters model behavior over time. (Theoretical Framework)
